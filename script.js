...
for (let i = 0; i < navLi.length; i++) {
  ...
  // Slide content section on click
...
// text effect and text array
  const dataText = ["Full-stack WebDeveloper", "Blogger", "Programmer", "Green-White Hat", "Cyber-Sec-Associate"];
